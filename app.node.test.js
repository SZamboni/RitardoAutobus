...
/*
describe('Testo il get delle fermate con parametri sbagliati', () => {
    test("Dovrebbe darmi 500 internal server error", (done) => {
        request(app)
        .get("/fermate/?latitude=46.0659276")
        .then((response) => {
...
/*
describe('Testo il get dei ritardi della fermata con parametri sbagliati', () => {
    test("Dovrebbe darmi internal server error 500", (done) => {
        request(app)
        .get("/ritardi/?idFermata'")
        .then((response) => {
          expect(response.statusCode).toBe(500);
          done();
        });
